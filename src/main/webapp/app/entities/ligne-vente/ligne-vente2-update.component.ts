...
@Component({
  selector: 'jhi-ligne-vente2-update',
  templateUrl: './ligne-vente2-update.component.html'
})
export class LigneVente2UpdateComponent implements OnInit {
  isSaving: boolean;
  ...
  addligne() {
    console.log('produit :' + this.editForm.get(['produit']).value);
    console.log('quantite :' + this.editForm.get(['ligneVenteQte']).value);
  }
