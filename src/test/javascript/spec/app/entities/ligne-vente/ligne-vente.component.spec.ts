...
import { LigneVenteComponent } from 'app/entities/ligne-vente/ligne-vente.component';
  ...
  describe('LigneVente Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LigneVenteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ligneVentes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
