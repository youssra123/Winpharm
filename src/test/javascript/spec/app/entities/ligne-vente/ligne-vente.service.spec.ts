...
describe('Service Tests', () => {
  describe('LigneVente Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(LigneVenteService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new LigneVente(0, 0, 0, 0, 0, 0, 'AAAAAAA');
    });
        ...
        const returnedFromService = Object.assign(
          {
            ligneVenteQte: 1,
            ligneVenteTotalHT: 1,
            ligneVenteTotalTTC: 1,
            ligneVentePrixTTC: 1,
            ligneVentePrixHT: 1,
            ligneVenteDesignation: 'BBBBBB'
          },
          elemDefault
        );
