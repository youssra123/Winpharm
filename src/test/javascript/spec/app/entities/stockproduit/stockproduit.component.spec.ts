...
import { StockproduitComponent } from 'app/entities/stockproduit/stockproduit.component';
...
describe('Component Tests', () => {
  describe('Stockproduit Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.stockproduits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
