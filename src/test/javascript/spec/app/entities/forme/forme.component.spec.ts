...
import { FormeComponent } from 'app/entities/forme/forme.component';
import { FormeService } from 'app/entities/forme/forme.service';
import { Forme } from 'app/shared/model/forme.model';

describe('Component Tests', () => {
  describe('Forme Management Component', () => {
    let comp: FormeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FormeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.formes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
