...
import { LaboratoireComponent } from 'app/entities/laboratoire/laboratoire.component';
...
describe('Component Tests', () => {
  describe('Laboratoire Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.laboratoires[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
