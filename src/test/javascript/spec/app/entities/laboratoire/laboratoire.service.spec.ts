...
describe('Service Tests', () => {
  describe('Laboratoire Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Laboratoire', async () => {
      ...
      it('should update a Laboratoire', async () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of Laboratoire', async () => {
        const returnedFromService = Object.assign(
          {
            laboratoireRaisSoc: 'BBBBBB',
            laboratoireAdresse: 'BBBBBB',
      ...
      it('should delete a Laboratoire', async () => {
