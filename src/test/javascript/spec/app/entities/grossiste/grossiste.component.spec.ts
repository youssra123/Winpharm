...
import { GrossisteComponent } from 'app/entities/grossiste/grossiste.component';
...
describe('Component Tests', () => {
  describe('Grossiste Management Component', () => {
    let comp: GrossisteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GrossisteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.grossistes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
