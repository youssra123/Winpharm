...
import { RayonComponent } from 'app/entities/rayon/rayon.component';
import { RayonService } from 'app/entities/rayon/rayon.service';
import { Rayon } from 'app/shared/model/rayon.model';

describe('Component Tests', () => {
  describe('Rayon Management Component', () => {
    let comp: RayonComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RayonComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rayons[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
