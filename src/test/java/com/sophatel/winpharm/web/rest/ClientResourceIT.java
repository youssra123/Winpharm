...
import com.sophatel.winpharm.repository.ClientRepository;
...
public class ClientResourceIT {
    ...
    @Test
    @Transactional
    public void checkClientNomIsRequired() throws Exception {
        int databaseSizeBeforeTest = clientRepository.findAll().size();
        // set the field null
        client.setClientNom(null);
    ...
    @Test
    @Transactional
    public void checkClientTelephoneIsRequired() throws Exception {
        int databaseSizeBeforeTest = clientRepository.findAll().size();
        // set the field null
        client.setClientTelephone(null);
